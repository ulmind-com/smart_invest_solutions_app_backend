...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admins/merge-family": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Primary and secondary account IDs",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_internal_domain.MergeFamilyAccountsRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_internal_domain.MergeFamilyAccountsResult"
                                        }
                                    }
                                }
                            ]
                    ...
                    "400": {
                        "description": "Bad request (e.g. same account twice, non-client role, or an account already merged)",
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.APIResponse"
                        }
                    },
        ...
        "/agency/imported-policies": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "unclaimed | linked | all (default: all)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Search by policy number or assured name",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Imported policies retrieved successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.PaginatedResponse"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/github_com_smart-invest-solutions_backend_internal_domain.ImportedPolicyView"
                                            }
                                        }
                                    }
                                }
        ...
        "/agency/imported-policies/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Imported policy ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Imported policy removed successfully",
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.APIResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request — row is linked to a client policy",
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.APIResponse"
                        }
                    },
        ...
        "/agency/imported-policies/{id}/link": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Client account, insured family member, and sum assured",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_internal_domain.LinkImportedPolicyDTO"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Policy linked successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.APIResponse"
                    ...
                    "400": {
                        "description": "Bad request — already linked, wrong client, or missing sum assured",
                        "schema": {
                            "$ref": "#/definitions/github_com_smart-invest-solutions_backend_pkg_response.APIResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "github_com_smart-invest-solutions_backend_internal_domain.ImportedPolicyView": {
            "type": "object",
            "properties": {
                "agency_id": {
                    "description": "AgencyID is the uploading admin's own AdminID — the hard agency boundary for this record.",
                    "type": "string"
                },
                "agent_code": {
                    "description": "AgentCode and DueMonth come from the PDF header — useful when an agency works more than one\nLIC agent code, and for telling at a glance how fresh a row is.",
                    "type": "string"
                },
                "assured_name": {
                    "type": "string"
                ...
                "flag": {
                    "description": "Flag is the PDF's \"Flg\" column: FY (first year), ST (2nd/3rd year), LP (last premium),\nMT (matures after this due), or empty.",
                    "type": "string"
                },
                "fup": {
                    "description": "FUP (\"first unpaid premium\") is kept exactly as printed, MM/YYYY.",
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "mode": {
                    "description": "Mode is normalized to the same vocabulary as PremiumDetails.PaymentMode.",
                    "type": "string"
                },
                "next_due_date": {
                    "type": "string"
                ...
                "plan_code": {
                    "description": "PlanCode and Term come from the PDF's \"Pln/Tm\" column (e.g. \"714/18\" → plan 714, term 18).",
                    "type": "string"
                },
                "policy_no": {
                    "type": "string"
        ...
        "github_com_smart-invest-solutions_backend_internal_domain.LinkImportedPolicyDTO": {
            "type": "object",
            "required": [
                "family_member_id",
                "sum_assured",
            ...
            "properties": {
                ...
                "plan_name": {
                    "description": "PlanName is free text (e.g. \"Jeevan Labh\"); the PDF only carries the numeric plan code.",
                    "type": "string"
                },
                "sum_assured": {
                    "type": "number"
        ...
        "github_com_smart-invest-solutions_backend_internal_domain.MergeFamilyAccountsRequest": {
            "type": "object",
            "required": [
                "primary_user_id",
                "secondary_user_id"
        ...
        "github_com_smart-invest-solutions_backend_internal_domain.MergeFamilyAccountsResult": {
            "type": "object",
            "properties": {
                "documents_moved": {
                    "type": "integer"
                },
                "family_members_moved": {
                    "type": "integer"
                },
                "fixed_deposits_moved": {
                    "type": "integer"
                },
                "general_policies_moved": {
                    "type": "integer"
                },
                "health_policies_moved": {
                    "type": "integer"
                },
                "life_policies_moved": {
                    "type": "integer"
        ...
        "github_com_smart-invest-solutions_backend_internal_domain.SyncResultDTO": {
            ...
            "properties": {
                ...
                "due_month": {
                    "description": "DueMonth / AgentCode / AgentName are read from the PDF header so the admin can confirm at a\nglance that they uploaded the file they meant to (right agent code, right month).",
                    "type": "string"
                },
                "failed_policies": {
                ...
                "newly_imported": {
                    "description": "NewlyImported counts rows that had never been seen in any previous upload — they are now\nsitting in the agency's policy inbox waiting to be linked to a client account.",
                    "type": "integer"
                },
                ...
                "unclaimed_total": {
                    "description": "UnclaimedTotal is the agency's *running* count of inbox rows with no client account yet —\nnot just from this upload, so it reflects the real size of the follow-up job.",
                    "type": "integer"
                },
                "unmapped_policies": {
                    "type": "array",
