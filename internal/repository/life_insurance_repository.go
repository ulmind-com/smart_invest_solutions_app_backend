...
func (r *lifeInsuranceRepository) GetAll(ctx context.Context, page, limit int64, isMapped *bool, licCustomerID string) ([]*domain.LifeInsuranceWithCustomer, int64, error) {
	skip := (page - 1) * limit
